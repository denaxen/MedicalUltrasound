...
class Node {
 private:
	...
	int obstacle_number{},
		vertice_number{};    // directions to next obstacle - this will depend on Obstacle organization
 ...
 public:
	Node(const Vector2 &pos = Vector2(),
	...
	Node(const Dot &dot, const double alpha);
